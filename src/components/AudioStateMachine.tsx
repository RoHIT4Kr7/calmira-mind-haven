...
export const useAudioStateMachine = ({
  ...
  const [currentPanel, setCurrentPanel] = useState<number>(1); // Start with panel 1
  ...
  const stopAudio = useCallback(() => {
    ...
    changeState("idle");
    setCurrentPanel(1); // Reset to panel 1
  }, [changeState]);
  ...
  }, [initialPanel, currentState, currentPanel, queuePanel, playPanel]);
